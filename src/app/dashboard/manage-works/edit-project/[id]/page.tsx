...
// TODO: ganti dengan data asli dari backend/database berdasarkan id
type ProjectData = {
  title: string;
  description: string;
...
const MOCK_PROJECTS: Record<string, ProjectData> = {
  "1": {
    ...
    imageUrl:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCB4mpOVzqrfYKLK4uydDxsdF2VEHYpFV3Mbf0lS7xLbA-Do7OQh1uGFAfv1Oza5xLGurtCDd_vn7xpJzFjcyzvdCb4YSL6cBLDBPnkWFyurV8ZuZSU9tSqXj7iYi0YgPkrz2fzmi06g8pktsDImdQ3-_HsC3EE9Wy-zMFWoILsaGTL-1dAox8TRhFt01NMODbqS4odve65WjMctb4yNmfU-A5umnSLsvBRFrRVvsyqJHVMJvhRFCNJnA",
    projectLink: "https://nexus-analytics.example.com",
    githubLink: "https://github.com/example/nexus-analytics",
  },
  "2": {
    title: "Quantum AI Interface",
    description: "ML Dashboard",
    imageUrl: null,
    projectLink: "https://quantum-ai.example.com",
    githubLink: "https://github.com/example/quantum-ai",
  },
};
...
export default function EditProject() {
  ...
  useEffect(() => {
    // TODO: ganti dengan fetch data project dari API berdasarkan projectId
    const data = projectId ? MOCK_PROJECTS[projectId] : undefined;
    if (data) {
      setTitle(data.title);
      setDescription(data.description.slice(0, DESCRIPTION_MAX_LENGTH));
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    // TODO: kirim data perubahan (title, description, file, projectLink, githubLink) ke backend
    ...
    <div className="bg-background text-on-background font-body-md min-h-screen flex">
      ...
      <main className="flex-1 md:ml-64 min-h-screen flex flex-col">
        ...
        <header className="hidden md:flex h-20 px-margin-desktop items-center justify-between border-b border-outline-variant/30 sticky top-0 bg-background/95 backdrop-blur z-30">
          ...
          <div className="flex gap-4">
            ...
            <button
              form="project-form"
              type="submit"
              className="px-6 py-2 rounded-xl font-bold bg-secondary text-on-secondary-container hover:shadow-[0_0_20px_rgba(123,208,255,0.3)] transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-secondary/50 flex items-center gap-2"
            >
              Save Changes
            </button>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-margin-mobile md:px-margin-desktop py-8 md:py-12 w-full flex-1">
          ...
          {isLoading ? (
            <div className="glass-panel rounded-xl p-6 text-on-surface-variant font-body-md text-body-md">
            ...
            <form id="project-form" className="space-y-8" onSubmit={handleSubmit}>
                      ...
                      {fileName ? (
                        ...
                        <>
                          <img
                            ...
                            alt="Current cover"
                            className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-25 transition-opacity"
                          />
                          <div className="relative z-10 flex flex-col items-center">
                            ...
                            <p className="font-body-md text-body-md text-on-surface mb-1">Click to replace image</p>
              ...
              <div className="sm:hidden fixed bottom-0 left-0 w-full p-4 bg-surface-container-lowest/95 backdrop-blur border-t border-outline-variant/30 z-40 flex gap-4">
                ...
                <button
                  form="project-form"
                  type="submit"
                  className="flex-1 px-4 py-3 rounded-xl font-bold bg-secondary text-on-secondary-container hover:shadow-[0_0_20px_rgba(123,208,255,0.3)] transition-all text-center flex items-center justify-center gap-2"
                >
                  Save
                </button>
              </div>
